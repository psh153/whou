      ...
      <div class="login-wrap">
        ...
        <div class="logo"><a class="navbar-brand"  href="/whou/main"><img src="/whou/resources/img/logo.svg"></a></div>
          ...
          <div class="input-wrap">
            ...
            <button type="button" class="btn login-btn btn-xs" id="btn1">비밀번호 찾기</button>
			<span class="find_1" style="color:red; text-align:left; display:none">일치하는 회원정보가 없습니다.</br> 입력하신 정보가 정확한지 확인해주세요.</span>
		        ...
		        $.ajax({
		            ...
		            success: function(result) {
		                if(result == 0) {
		                	...
		                	window.location.href = "/whou/member/findPwPro2?result=" + result;
		                } 
